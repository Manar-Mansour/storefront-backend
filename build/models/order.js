...
var OrderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not add new order ".concat(o, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.addProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var ordersql, conn, result, order, err_4, conn, sql, result, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    OrderStore.prototype.getProducts = function (orderId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not get products in order ".concat(orderId, ". Error: ").concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.reset = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, sql2, result, err_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        ...
                        sql2 = 'ALTER SEQUENCE orders_id_seq RESTART WITH 1';
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                    ...
                    case 4:
                        err_7 = _a.sent();
                        throw new Error("Could not reset orders. Error: ".concat(err_7));
                    case 5: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.resetOrderProducts = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, sql2, result, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'DELETE FROM order_products CASCADE';
                        sql2 = 'ALTER SEQUENCE order_products_id_seq RESTART WITH 1';
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        return [4 /*yield*/, conn.query(sql2)];
                    ...
                    case 4:
                        err_8 = _a.sent();
                        throw new Error("Could not reset order_products. Error: ".concat(err_8));
                    case 5: return [2 /*return*/];
                }
            });
        });
